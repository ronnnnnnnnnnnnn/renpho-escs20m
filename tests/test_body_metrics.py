...
GOLDEN_METRICS = {
    'M43-1': {'body_mass_index': 26.4, 'body_fat_percentage': 21.7, 'fat_free_mass': 59.74, 'body_water_percentage': 56.5, 'skeletal_muscle_percentage': 50.5, 'bone_mass': 2.97, 'muscle_mass': 56.77, 'protein_percentage': 17.9, 'basal_metabolic_rate': 1652},
    'M43-2': {'body_mass_index': 26.3, 'body_fat_percentage': 21.6, 'fat_free_mass': 59.62, 'body_water_percentage': 56.6, 'skeletal_muscle_percentage': 50.6, 'bone_mass': 2.96, 'muscle_mass': 56.66, 'protein_percentage': 17.9, 'basal_metabolic_rate': 1648},
    'M43-3': {'body_mass_index': 26.8, 'body_fat_percentage': 22.2, 'fat_free_mass': 60.18, 'body_water_percentage': 56.2, 'skeletal_muscle_percentage': 50.2, 'bone_mass': 3.02, 'muscle_mass': 57.16, 'protein_percentage': 17.7, 'basal_metabolic_rate': 1674},
    'F25-1': {'body_mass_index': 28.0, 'body_fat_percentage': 32.0, 'fat_free_mass': 51.88, 'body_water_percentage': 46.7, 'skeletal_muscle_percentage': 39.6, 'bone_mass': 3.12, 'muscle_mass': 48.76, 'protein_percentage': 15.7, 'basal_metabolic_rate': 1493},
    'F25-2': {'body_mass_index': 27.9, 'body_fat_percentage': 31.9, 'fat_free_mass': 51.79, 'body_water_percentage': 46.7, 'skeletal_muscle_percentage': 39.7, 'bone_mass': 3.12, 'muscle_mass': 48.67, 'protein_percentage': 15.7, 'basal_metabolic_rate': 1493},
    'F25-3': {'body_mass_index': 28.4, 'body_fat_percentage': 32.6, 'fat_free_mass': 52.13, 'body_water_percentage': 46.2, 'skeletal_muscle_percentage': 39.3, 'bone_mass': 3.09, 'muscle_mass': 49.04, 'protein_percentage': 15.5, 'basal_metabolic_rate': 1482},
    'M55-1': {'body_mass_index': 24.3, 'body_fat_percentage': 19.7, 'fat_free_mass': 61.07, 'body_water_percentage': 58.0, 'skeletal_muscle_percentage': 51.8, 'bone_mass': 3.04, 'muscle_mass': 58.03, 'protein_percentage': 18.3, 'basal_metabolic_rate': 1683},
    'M55-2': {'body_mass_index': 24.3, 'body_fat_percentage': 19.7, 'fat_free_mass': 61.07, 'body_water_percentage': 58.0, 'skeletal_muscle_percentage': 51.8, 'bone_mass': 3.04, 'muscle_mass': 58.03, 'protein_percentage': 18.3, 'basal_metabolic_rate': 1683},
    'M55-3': {'body_mass_index': 24.7, 'body_fat_percentage': 20.3, 'fat_free_mass': 61.65, 'body_water_percentage': 57.5, 'skeletal_muscle_percentage': 51.4, 'bone_mass': 3.10, 'muscle_mass': 58.55, 'protein_percentage': 18.2, 'basal_metabolic_rate': 1708},
    'M36-1': {'body_mass_index': 22.3, 'body_fat_percentage': 13.3, 'fat_free_mass': 66.20, 'body_water_percentage': 62.6, 'skeletal_muscle_percentage': 56.0, 'bone_mass': 3.29, 'muscle_mass': 62.91, 'protein_percentage': 19.8, 'basal_metabolic_rate': 1790},
    'M36-2': {'body_mass_index': 22.2, 'body_fat_percentage': 13.2, 'fat_free_mass': 65.97, 'body_water_percentage': 62.7, 'skeletal_muscle_percentage': 56.1, 'bone_mass': 3.27, 'muscle_mass': 62.70, 'protein_percentage': 19.8, 'basal_metabolic_rate': 1782},
    'M36-3': {'body_mass_index': 22.6, 'body_fat_percentage': 13.6, 'fat_free_mass': 66.83, 'body_water_percentage': 62.4, 'skeletal_muscle_percentage': 55.8, 'bone_mass': 3.33, 'muscle_mass': 63.50, 'protein_percentage': 19.7, 'basal_metabolic_rate': 1808},
    'F30-1': {'body_mass_index': 23.6, 'body_fat_percentage': 19.5, 'fat_free_mass': 61.46, 'body_water_percentage': 55.2, 'skeletal_muscle_percentage': 47.0, 'bone_mass': 3.66, 'muscle_mass': 57.80, 'protein_percentage': 19.4, 'basal_metabolic_rate': 1687},
    'F30-2': {'body_mass_index': 23.5, 'body_fat_percentage': 19.4, 'fat_free_mass': 61.26, 'body_water_percentage': 55.3, 'skeletal_muscle_percentage': 47.0, 'bone_mass': 3.65, 'muscle_mass': 57.61, 'protein_percentage': 19.5, 'basal_metabolic_rate': 1683},
    'F30-3': {'body_mass_index': 23.9, 'body_fat_percentage': 19.8, 'fat_free_mass': 62.03, 'body_water_percentage': 55.0, 'skeletal_muscle_percentage': 46.8, 'bone_mass': 3.71, 'muscle_mass': 58.32, 'protein_percentage': 19.4, 'basal_metabolic_rate': 1705},
    'F42-1': {'body_mass_index': 36.2, 'body_fat_percentage': 43.6, 'fat_free_mass': 42.92, 'body_water_percentage': 38.7, 'skeletal_muscle_percentage': 32.8, 'bone_mass': 2.59, 'muscle_mass': 40.33, 'protein_percentage': 12.2, 'basal_metabolic_rate': 1302},
    'F42-2': {'body_mass_index': 39.5, 'body_fat_percentage': 45.1, 'fat_free_mass': 45.59, 'body_water_percentage': 37.7, 'skeletal_muscle_percentage': 31.9, 'bone_mass': 2.74, 'muscle_mass': 42.85, 'protein_percentage': 11.7, 'basal_metabolic_rate': 1356},
    'M21':   {'body_mass_index': 19.0, 'body_fat_percentage':  9.8, 'fat_free_mass': 67.97, 'body_water_percentage': 65.1, 'skeletal_muscle_percentage': 58.3, 'bone_mass': 3.40, 'muscle_mass': 64.57, 'protein_percentage': 20.6, 'basal_metabolic_rate': 1838},
}
...
def test_body_metrics_matches_golden(label, sex, athlete, height_m, age, frame_hex):
    ...
    actual = {
        ...
        'fat_free_mass':            metrics.fat_free_mass,
